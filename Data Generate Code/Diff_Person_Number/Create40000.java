...
public class Create40000 {
	public static void main(String[] args) throws IOException {
		final int numberOfPeople = 40000;
		...
		for(int j = 0; j <100;j++) {
			...
			p5.println(genderAge);
			String relation5 = "match (c:Age), (d:Gender) where c.age = "+j+" and d.name='" +"Male"+"' and c.name=d.name create (d)-[r:GenderToAge]->(c);";
			p5.println(relation5);
			relation5 = "match (c:Age), (d:Gender) where c.age = "+j+" and d.name='" +"Female"+"' and c.name=d.name create (d)-[r:GenderToAge]->(c)";
			p5.println(relation5);
		}
		/*
		...
		for (int i = 0; i <numberOfPeople; i++) {
			...
			// create relation
			String query1 = "create (P" + (i + 1) + ":Person{ID: "+(i+1) +", name:'" + firstname + " " + lastname + "',age:" + age
					+ "});";
			p1.println(query1);
			String relation1 = "match (a:Gender),(b:Person) where a.name='"+gender+"' and b.ID="+(i+1)+" create (a)-[r:Has_Gender]->(b);";
			p1.println(relation1);
			
			String query2 = "create (P" + (i + 1) + ":Person {ID: "+(i+1) +",name:'" + firstname + " " + lastname + "',gender:'"
					+ gender + "'});";
			p2.println(query2);
			String relation2 = "match (a:Age),(b:Person) where a.age= "+age+ " and b.ID="+(i+1)+" create (a)-[r:Has_Age]->(b);";
			p2.println(relation2);
			
			//age and gender
			String query3 = "create (P" + (i + 1) + ":Person {ID: "+(i+1)+",name:'" + firstname + " " + lastname + "'});";
			p3.println(query3);
			String relation3 = "match (a:Age),(b:Person) where a.age =" + age + " and b.ID ="+(i+1)+" create (a)-[r:Has_Age]->(b);";
			p3.println(relation3);
			relation3 = "match (a:Gender),(b:Person) where a.name='"+gender+"' and b.ID="+(i+1)+" create (a)-[r:Has_Gender]->(b);";
			p3.println(relation3);
			
			//age above gender
			String query4 = "create (P" + (i + 1) + ":Person {ID: "+(i+1)+",name:'" + firstname + " " + lastname + "'});";
			p4.println(query4);
			String relation4 = "match (a:Gender),(b:Person) where a.name='"+gender+"' and a.age="+ age +" and b.ID="+(i+1)+" create (a)-[r:Has_Gender]->(b);";
			p4.println(relation4);
			...
			p5.println(query5);
			String relation5 = "match (a:Age),(b:Person) where a.age =" + age + " and a.name='"+gender+"' and b.ID ="+(i+1)+" create (a)-[r:Has_Age]->(b);";
			p5.println(relation5);
